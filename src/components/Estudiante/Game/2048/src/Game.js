      ...
      <div className="game" id="game">
        <div className="game-board" id="game-board">
          <div className="status">
            <span>Puntaje: {this.state.score}</span>
          </div>
          <div className="status">
            {this.state.rewinds > 0 ? <span>Retrocesos usados: {this.state.rewinds}</span> : null}
          </div>
          <div className="game-info">
            <span>{(this.state.isStarted && !this.state.isMoved) ? "Ningún movimiento" : null}</span>
          </div>
          <Board
        ...
        <div className="game-buttons">
          <ul>
            <button className="veryBoringButton" onClick={this.reset}>Nuevo Juego</button>
            <button className="veryBoringButton" onClick={this.rewind}>Retroceder</button>
          </ul>
        </div>
      </div>
    );
